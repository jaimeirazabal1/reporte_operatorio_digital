...
class Breadcrumb
{
    ...
    public function display()
    {
        ...
        {
            return "<ol class='{$this->attrs['class_ul']}'>" . implode('', $html) . '</ol>';
        }
        else
        {
            return "<ol class='{$this->attrs['class_ul']}'>" . implode("<li class='{$this->attrs['class_separator']}'><a href='javascript: void(0)'>{$this->attrs['separator']}</a></li>", $html) . '</ol>';
        }
    }
    /**
     * Breadcrumb::getArray()
